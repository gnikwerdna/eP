namespace eP.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProductCompliances", "Compliance_ComplianceID", "dbo.Compliances");
            DropForeignKey("dbo.ProductCompliances", "Product_ProductID", "dbo.Products");
            ...
            DropIndex("dbo.ProductCompliances", new[] { "Compliance_ComplianceID" });
            DropIndex("dbo.ProductCompliances", new[] { "Product_ProductID" });
